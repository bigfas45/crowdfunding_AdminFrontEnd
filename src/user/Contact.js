  ...
  const showLoading = () => {
    if (success) {
      return dashboarddashboard2(
        ...
        `Your ${email} has been added successfully, you have subscribed to the crowd funding newsletter to get the latest news and offers. `
      );
    }
    if (error) {
                    ...
                    <div className="form-row">
                      ...
                      <div className="form-group col-md-12">
                        <div className="custom-control custom-checkbox">
                          ...
                          />
                          <label
                            className="custom-control-label pr-5"
                            for="customCheck1"
                          >
