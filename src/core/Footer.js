        ...
        return (
          <Fragment>
            <footer class="footer bg-dark space-pt">
                ...
                <div class="row">
                    ...
                    <div class="footer-contact-info">
                      ...
                      <ul class="list-unstyled mb-0">
                        <li>
                          ...
                          <span>
                            9th Floor, UBA House, 57 Marina, Lagos State,
                            Nigeria
                          </span>{' '}
                        </li>
                        <li>
                        ...
                        <li>
                          ...
                          <span>info@ventureramp.com.ng</span>{' '}
                        </li>
                      </ul>
                    </div>
                  </div>
                  <div class="col-lg-4 col-md-6 mt-4 mt-md-0">
                    <div class="footer-link">
                      ...
                      <ul class="list-unstyled mb-0">
                        ...
                        <li>
                          {' '}
                          <Link to="/complaintsfrom">Complaint </Link>{' '}
                        </li>
                        <li>
                          {' '}
                          <a href="#">Fees </a>{' '}
                      ...
                      <ul class="list-unstyled mb-0">
                        <li>
                          {' '}
                          <Link to="/riskwarning">Risk Warnings </Link>{' '}
                        </li>
                        <li>
                          {' '}
                          <Link to="/privatenotice">Privacy Notice</Link>{' '}
                        </li>
                        <li>
                          {' '}
                  ...
                  <div class="col-lg-4 col-md-6 mt-4 mt-lg-0">
                    ...
                    <div class="footer-subscribe">
                      <p class="text-white">
                        Sign up to our newsletter to get the latest news and
                        offers.
                      </p>
                      <form>
                  ...
                  <div class="row align-items-center">
                    <div class="col-md-4 text-center text-md-right">
                      <p class="mb-0 text-white">
                        ...
                        <a href="#"> VentureRamp 2020 </a> All Rights Reserved{' '}
                      </p>
                    </div>
                    ...
                    <div class="col-md-4 text-center text-md-right">
                      <p class="mb-0 " style={{ color: 'white' }}>
                        ...
                        | <Link to="/Privacypolicy">
                          {' '}
                          Privacy Policy
                        </Link> | <Link to="/term_of_use">Terms of Use</Link>
                      </p>
                    </div>
                  </div>
                </div>
              ...
              >
                <p>
                  We use cookies to enhance your activities and preferences on
                  our website and to make your visit to the site efficient. By
                  browsing our website, you consent to our use of cookies. For
